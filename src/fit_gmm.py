...
def fit_gmm(contrasts: np.ndarray, metaparams: list, guesses: dict):
    ...
    return {
        "means_in_contrast": [gmm.means_.ravel()],
        "sigmas_in_contrast": [gmm.covariances_.ravel()],
        "weights": [gmm.weights_.ravel()],
        "metrics": {
            "score": gmm.score(contrasts),
            "aic": gmm.aic(contrasts),
            "bic": gmm.bic(contrasts),
            "scores_per_sample": gmm.score_samples(contrasts),
        },
    }
